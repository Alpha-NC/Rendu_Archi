...
**Toujours non commencé :** authentification mono-utilisateur, jobs asynchrones, Route Handlers/UI au-delà des références d'état ci-dessus, la bascule elle-même (obtenirDepot pointe toujours vers Supabase).
