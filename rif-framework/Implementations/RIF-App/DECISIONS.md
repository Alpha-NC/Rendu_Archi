...
- `BLOB_READ_WRITE_TOKEN` absent de `.env.local` — action utilisateur dans le dashboard Vercel ; sans lui, tout dépôt/lecture de fichier échoue en pratique malgré le code branché.
