...
- **Aucun compte utilisateur n'existe** (`neon_auth."user"` : 0 ligne) — personne ne peut se connecter tant qu'un compte n'est pas créé pour Évariste Blasco ; pas de page d'inscription dans l'app, décision de méthode à prendre avec l'utilisateur.
