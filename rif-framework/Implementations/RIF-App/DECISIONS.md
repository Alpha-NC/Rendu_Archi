...
- Exécuter `npm run db:migrate` en production pour enregistrer `0001_initial_schema.sql` dans `schema_migrations` (idempotent, mais jamais lancé pour de vrai depuis cet environnement).
