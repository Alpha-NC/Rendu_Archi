...
**Toujours non commencé :** Neon PostgreSQL, Vercel Blob, authentification mono-utilisateur, jobs asynchrones, Route Handlers/UI au-delà des références d'état ci-dessus, migration Supabase.
